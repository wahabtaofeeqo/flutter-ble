...
class CharacteristicInteractionDialog extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => _CharacteristicInteractionDialog(characteristic: characteristic);
}
...
class _CharacteristicInteractionDialogState extends State<_CharacteristicInteractionDialog> {
  ...
  void initState() {
    ...
    //
    // if(widget.characteristic.isWritableWithResponse || widget.characteristic.isWritableWithoutResponse) {
    //   widget.characteristic.write([55, 02, 01, 00]);
    // }
  ...
  Future<void> subscribeCharacteristic() async {
    subscribeStream = widget.characteristic.subscribe().listen((event) {
      setState(() {
        subscribeOutput =  utf8.decode(event); // event.toString();
      });
    });
  ...
  Future<void> readCharacteristic() async {
    print("SID: ${widget.characteristic.service.id}");
